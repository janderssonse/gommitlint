...
# Description: This script generates shell completions for the gommitlint binary.
...
#
# Note: This script requires the gommitlint binary to be built and available
